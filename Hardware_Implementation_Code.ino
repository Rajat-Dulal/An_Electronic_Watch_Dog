...
#define FWD       0xFF18E7 // go forward
#define LFT       0xFF10EF // go left
#define RGT       0xFF5AA5 // go right
#define BWD       0xFF4AB5 // go backward
#define STOP      0xFF38C7 // stop
#define RESET     0xFFA25D // Resets the Arduino Board(RED)
#define RPEAT     0xFFA857 // repeat the stored sequence of movement from the temporary memory(automatically stores)
#define DEL       0xFFE01F // delete the stored sequence of movement from temporary memory(EQ)
